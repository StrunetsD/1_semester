...
double S(double x)//функция для вычисления аппроксимации функции
{
    double sum = 0, h = 0.00001,  y = 0;// sum  - текущая сумма ряда , h - шаг , с которым будет изменяться переменная x , y - сохранение точного значения функции 
